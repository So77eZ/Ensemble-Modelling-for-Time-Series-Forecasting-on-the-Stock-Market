...
│                                                                 │
│  OHLCV (5) + Технические индикаторы (17) + Фундаментал (17)     │
│                                                                 │
...
│  Общий скейлер для всех 39 признаков + отдельный для Close      │
└───────────────────────────────┬─────────────────────────────────┘
                                ▼
┌─────────────────────────────────────────────────────────────────┐
│           ФОРМИРОВАНИЕ ПОСЛЕДОВАТЕЛЬНОСТЕЙ                      │
│  Скользящее окно LSTM_LOOK_BACK (30 дней)                       │
│  X.shape = (N, 30, 39),  y.shape = (N,)                         │
└───────────────────────────────┬─────────────────────────────────┘
                                ▼
┌─────────────────────────────────────────────────────────────────┐
...
DataFrame (39 признаков) → MinMaxScaler → нормализованный массив
    → скользящее окно LOOK_BACK=30 → X (N, 30, 39), y (N,)
